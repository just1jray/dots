...
- `~/.claude/{settings.json,hooks,skills,CLAUDE.md}` → individual items in `claude/`

Note: `claude/CLAUDE.md` contains global Claude Code settings that apply to all projects.
