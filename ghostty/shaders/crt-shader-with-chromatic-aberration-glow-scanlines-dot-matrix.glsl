...
const float ABBERATION_FACTOR = 0.001;    // Strength of color splitting effect (default: 0.05)
...
// Scanline Settings
const float SCANLINE_INTENSITY = 0.01;    // Overall intensity of scanlines (default: 1.0)
const float SCANLINE_DENSITY = 0.01;     // Density/thickness of scanlines (default: 0.25)
