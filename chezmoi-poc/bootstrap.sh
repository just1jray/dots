...
echo "  1. Initialize chezmoi (first time only):"
echo "     chezmoi init --source ."
echo "     # You'll be prompted for:"
echo "     #   - name, email, work (bool)"
echo "     #   - use_1password (bool) - answer 'f' for now"
echo ""
echo "  2. Preview changes (dry run):"
echo "     chezmoi diff          # See what would change"
echo ""
echo "  3. Run the interactive test script:"
echo "     ./TEST.sh"
echo "     # Or apply manually: chezmoi apply -v"
echo ""
echo "  4. For 1Password integration (optional):"
...
echo "     - Re-initialize: chezmoi init --source ."
echo "     - Answer 't' to use_1password prompt"
echo ""
